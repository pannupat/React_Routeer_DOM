...
const HomePage = () => {
  return (
    <div className="homediv">
      <div className="headtitle border-Fuchsia-500">
        ...
        <div className="flex flex-col gap-4" key={tn.id}>
          ...
          <div className="flex flex-col gap-4">
            {tn.news_type
              ...
              .map((nt: NewsType) => (
                <Link
                  className="allnew flex flex-col p-4 gap-2    hover:bg-Fuchsia-500 active:bg-Fuchsia-500 hover: transition border-Fuchsia-500"
